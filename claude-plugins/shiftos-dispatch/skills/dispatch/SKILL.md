...
- **Preferred:** Claude Opus 4.8 at the runtime's default effort.
- **Minimum:** Claude Sonnet 5 at the runtime's default effort.
- Do not lower the effort setting for speed.
- Heavy generation and review subagents must use Opus 4.8 or Sonnet 5. Prefer Opus 4.8 for complex, multi-file, high-risk, or audience-facing work.
